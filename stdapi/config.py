...
class _Settings(BaseSettings):
    ...
    model_cache_shared: bool = Field(
        ...
        description=(
            ...
            "Servers only share a list when they run the same version and the "
            "same aws_bedrock_* configuration; anything else is read as an "
            "empty cache, which is why a rolling deployment briefly has every "
            "server discovering on its own again.\n\n"
            "Example: true\n\n"
