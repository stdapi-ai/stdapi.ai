...
- :material-star-settings: __Advanced Bedrock capabilities__
  <br>Prompt caching, guardrails, service tiers, application inference profiles, prompt routers, S3 inputs, and stored conversations—all through compatible API parameters.

- :material-api: __Complete multi-modal API__
  <br>Chat, image, video, audio, embeddings, reranking, and content moderation. Every route maps compatible parameters to Bedrock equivalents.

- :material-aws: __Native AWS AI services__
  <br>Amazon Polly (text-to-speech), Transcribe (speech-to-text with speaker diarization), Comprehend (moderation), Translate—all unified under compatible endpoints.
