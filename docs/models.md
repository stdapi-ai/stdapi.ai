---
title: Models - AWS Model Catalogue on the OpenAI, Anthropic, Cohere & Ollama APIs
description: Browse, filter, chart and compare every model stdapi.ai serves on AWS through the OpenAI, Anthropic, Cohere and Ollama APIs - modalities, regional availability, published AWS prices and independent leaderboard scores, side by side.
keywords: AWS AI model list, Amazon Bedrock model list, Bedrock model comparison, Bedrock pricing table, AI model catalogue AWS, compare LLM prices AWS, Bedrock model availability by region, OpenAI compatible model list, Ollama compatible model list AWS
hide:
  - navigation
  - toc
---
...
[OpenAI, Anthropic, Cohere and Ollama APIs](features.md) your tools already
speak.
...
<!-- catalog:noscript -->
<table><thead><tr><th>Model</th><th>ID</th><th>Provider</th><th>Service</th><th>Input</th><th>Output</th><th>Regions</th></tr></thead><tbody>
<tr><td>Jamba 1.5 Large (legacy)</td><td><code>ai21.jamba-1-5-large-v1:0</code></td><td>AI21 Labs</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>1</td></tr>
<tr><td>Jamba 1.5 Mini (legacy)</td><td><code>ai21.jamba-1-5-mini-v1:0</code></td><td>AI21 Labs</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>1</td></tr>
<tr><td>Bedrock Guardrail Checks</td><td><code>amazon.bedrock-runtime-guardrail-checks</code></td><td>Amazon</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>MODERATION</td><td>7</td></tr>
<tr><td>Comprehend Toxicity Detection</td><td><code>amazon.comprehend-toxicity</code></td><td>Amazon</td><td>AWS Comprehend</td><td>TEXT</td><td>MODERATION</td><td>33</td></tr>
<tr><td>Nova 2 Lite</td><td><code>amazon.nova-2-lite-v1:0</code></td><td>Amazon</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE, VIDEO</td><td>TEXT</td><td>25</td></tr>
<tr><td>Amazon Nova Multimodal Embeddings</td><td><code>amazon.nova-2-multimodal-embeddings-v1:0</code></td><td>Amazon</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE, AUDIO, VIDEO</td><td>EMBEDDING</td><td>1</td></tr>
<tr><td>Nova 2 Sonic</td><td><code>amazon.nova-2-sonic-v1:0</code></td><td>Amazon</td><td>AWS Bedrock Runtime</td><td>SPEECH</td><td>SPEECH, TEXT</td><td>4</td></tr>
<tr><td>Nova Canvas (legacy)</td><td><code>amazon.nova-canvas-v1:0</code></td><td>Amazon</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>IMAGE</td><td>3</td></tr>
<tr><td>Nova Lite</td><td><code>amazon.nova-lite-v1:0</code></td><td>Amazon</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE, VIDEO</td><td>TEXT</td><td>24</td></tr>
<tr><td>Nova Micro</td><td><code>amazon.nova-micro-v1:0</code></td><td>Amazon</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>20</td></tr>
<tr><td>Nova Premier (legacy)</td><td><code>amazon.nova-premier-v1:0</code></td><td>Amazon</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE, VIDEO</td><td>TEXT</td><td>3</td></tr>
<tr><td>Nova Pro</td><td><code>amazon.nova-pro-v1:0</code></td><td>Amazon</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE, VIDEO</td><td>TEXT</td><td>22</td></tr>
<tr><td>Nova Reel (legacy)</td><td><code>amazon.nova-reel-v1:0</code></td><td>Amazon</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>VIDEO</td><td>3</td></tr>
<tr><td>Nova Reel (legacy)</td><td><code>amazon.nova-reel-v1:1</code></td><td>Amazon</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>VIDEO</td><td>1</td></tr>
<tr><td>Nova Sonic (legacy)</td><td><code>amazon.nova-sonic-v1:0</code></td><td>Amazon</td><td>AWS Bedrock Runtime</td><td>SPEECH</td><td>SPEECH, TEXT</td><td>3</td></tr>
<tr><td>Polly Generative</td><td><code>amazon.polly-generative</code></td><td>Amazon</td><td>AWS Polly</td><td>TEXT</td><td>SPEECH</td><td>10</td></tr>
<tr><td>Polly Long-form</td><td><code>amazon.polly-long-form</code></td><td>Amazon</td><td>AWS Polly</td><td>TEXT</td><td>SPEECH</td><td>1</td></tr>
<tr><td>Polly Neural</td><td><code>amazon.polly-neural</code></td><td>Amazon</td><td>AWS Polly</td><td>TEXT</td><td>SPEECH</td><td>18</td></tr>
<tr><td>Polly Standard</td><td><code>amazon.polly-standard</code></td><td>Amazon</td><td>AWS Polly</td><td>TEXT</td><td>SPEECH</td><td>20</td></tr>
<tr><td>Rerank 1.0</td><td><code>amazon.rerank-v1:0</code></td><td>Amazon</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>RERANKING</td><td>4</td></tr>
...
<tr><td>Claude 3 Haiku (legacy)</td><td><code>anthropic.claude-3-haiku-20240307-v1:0</code></td><td>Anthropic</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>TEXT</td><td>15</td></tr>
<tr><td>Claude 3 Sonnet</td><td><code>anthropic.claude-3-sonnet-20240229-v1:0</code></td><td>Anthropic</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>TEXT</td><td>5</td></tr>
...
<tr><td>Claude Opus 4.6</td><td><code>anthropic.claude-opus-4-6-v1</code></td><td>Anthropic</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>TEXT</td><td>31</td></tr>
...
<tr><td>Gemma 3 4B IT</td><td><code>google.gemma-3-4b-it</code></td><td>Google</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>TEXT</td><td>10</td></tr>
<tr><td>Gemma 4 26B A4B</td><td><code>google.gemma-4-26b-a4b</code></td><td>Google</td><td>AWS Bedrock Mantle</td><td>TEXT, IMAGE</td><td>TEXT</td><td>4</td></tr>
<tr><td>Gemma 4 31B</td><td><code>google.gemma-4-31b</code></td><td>Google</td><td>AWS Bedrock Mantle</td><td>TEXT, IMAGE</td><td>TEXT</td><td>4</td></tr>
<tr><td>Gemma 4 E2B</td><td><code>google.gemma-4-e2b</code></td><td>Google</td><td>AWS Bedrock Mantle</td><td>TEXT, IMAGE</td><td>TEXT</td><td>4</td></tr>
<tr><td>Ray v2</td><td><code>luma.ray-v2:0</code></td><td>Luma AI</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>VIDEO</td><td>1</td></tr>
<tr><td>Llama 3.1 70B Instruct</td><td><code>meta.llama3-1-70b-instruct-v1:0</code></td><td>Meta</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>3</td></tr>
<tr><td>Llama 3.1 8B Instruct</td><td><code>meta.llama3-1-8b-instruct-v1:0</code></td><td>Meta</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>3</td></tr>
<tr><td>Llama 3.3 70B Instruct</td><td><code>meta.llama3-3-70b-instruct-v1:0</code></td><td>Meta</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>3</td></tr>
<tr><td>Llama 3 70B Instruct</td><td><code>meta.llama3-70b-instruct-v1:0</code></td><td>Meta</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>5</td></tr>
<tr><td>Llama 3 8B Instruct</td><td><code>meta.llama3-8b-instruct-v1:0</code></td><td>Meta</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>5</td></tr>
<tr><td>Llama 4 Maverick 17B Instruct</td><td><code>meta.llama4-maverick-17b-instruct-v1:0</code></td><td>Meta</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>TEXT</td><td>4</td></tr>
<tr><td>Llama 4 Scout 17B Instruct</td><td><code>meta.llama4-scout-17b-instruct-v1:0</code></td><td>Meta</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>TEXT</td><td>4</td></tr>
<tr><td>MiniMax M2</td><td><code>minimax.minimax-m2</code></td><td>MiniMax</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>10</td></tr>
<tr><td>MiniMax M2.1</td><td><code>minimax.minimax-m2.1</code></td><td>MiniMax</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>13</td></tr>
<tr><td>MiniMax M2.5</td><td><code>minimax.minimax-m2.5</code></td><td>MiniMax</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>13</td></tr>
<tr><td>Devstral 2 123B</td><td><code>mistral.devstral-2-123b</code></td><td>Mistral AI</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>13</td></tr>
<tr><td>Magistral Small 2509</td><td><code>mistral.magistral-small-2509</code></td><td>Mistral AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>TEXT</td><td>10</td></tr>
<tr><td>Ministral 14B 3.0</td><td><code>mistral.ministral-3-14b-instruct</code></td><td>Mistral AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>TEXT</td><td>10</td></tr>
<tr><td>Ministral 3B</td><td><code>mistral.ministral-3-3b-instruct</code></td><td>Mistral AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>TEXT</td><td>10</td></tr>
<tr><td>Ministral 3 8B</td><td><code>mistral.ministral-3-8b-instruct</code></td><td>Mistral AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>TEXT</td><td>10</td></tr>
<tr><td>Mistral 7B Instruct</td><td><code>mistral.mistral-7b-instruct-v0:2</code></td><td>Mistral AI</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>9</td></tr>
<tr><td>Mistral Large (24.02)</td><td><code>mistral.mistral-large-2402-v1:0</code></td><td>Mistral AI</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>9</td></tr>
<tr><td>Mistral Large (24.07)</td><td><code>mistral.mistral-large-2407-v1:0</code></td><td>Mistral AI</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>1</td></tr>
<tr><td>Mistral Large 3</td><td><code>mistral.mistral-large-3-675b-instruct</code></td><td>Mistral AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>TEXT</td><td>7</td></tr>
<tr><td>Mistral Small (24.02)</td><td><code>mistral.mistral-small-2402-v1:0</code></td><td>Mistral AI</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>1</td></tr>
<tr><td>Mixtral 8x7B Instruct</td><td><code>mistral.mixtral-8x7b-instruct-v0:1</code></td><td>Mistral AI</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>9</td></tr>
...
<tr><td>Stable Image Fast Upscale</td><td><code>stability.stable-fast-upscale-v1:0</code></td><td>Stability AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>IMAGE</td><td>3</td></tr>
<tr><td>Stable Image Control Sketch</td><td><code>stability.stable-image-control-sketch-v1:0</code></td><td>Stability AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>IMAGE</td><td>3</td></tr>
<tr><td>Stable Image Control Structure</td><td><code>stability.stable-image-control-structure-v1:0</code></td><td>Stability AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>IMAGE</td><td>3</td></tr>
<tr><td>Stable Image Core 1.0</td><td><code>stability.stable-image-core-v1:1</code></td><td>Stability AI</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>IMAGE</td><td>1</td></tr>
<tr><td>Stable Image Erase Object</td><td><code>stability.stable-image-erase-object-v1:0</code></td><td>Stability AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>IMAGE</td><td>3</td></tr>
<tr><td>Stable Image Inpaint</td><td><code>stability.stable-image-inpaint-v1:0</code></td><td>Stability AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>IMAGE</td><td>3</td></tr>
<tr><td>Stable Image Remove Background</td><td><code>stability.stable-image-remove-background-v1:0</code></td><td>Stability AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>IMAGE</td><td>3</td></tr>
<tr><td>Stable Image Search and Recolor</td><td><code>stability.stable-image-search-recolor-v1:0</code></td><td>Stability AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>IMAGE</td><td>3</td></tr>
<tr><td>Stable Image Search and Replace</td><td><code>stability.stable-image-search-replace-v1:0</code></td><td>Stability AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>IMAGE</td><td>3</td></tr>
<tr><td>Stable Image Style Guide</td><td><code>stability.stable-image-style-guide-v1:0</code></td><td>Stability AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>IMAGE</td><td>3</td></tr>
<tr><td>Stable Image Ultra 1.0</td><td><code>stability.stable-image-ultra-v1:1</code></td><td>Stability AI</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>IMAGE</td><td>1</td></tr>
<tr><td>Stable Image Outpaint</td><td><code>stability.stable-outpaint-v1:0</code></td><td>Stability AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>IMAGE</td><td>3</td></tr>
<tr><td>Stable Image Style Transfer</td><td><code>stability.stable-style-transfer-v1:0</code></td><td>Stability AI</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>IMAGE</td><td>3</td></tr>
<tr><td>Marengo Embed v2.7 (legacy)</td><td><code>twelvelabs.marengo-embed-2-7-v1:0</code></td><td>TwelveLabs</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE, SPEECH, VIDEO</td><td>EMBEDDING</td><td>3</td></tr>
<tr><td>Marengo Embed 3.0</td><td><code>twelvelabs.marengo-embed-3-0-v1:0</code></td><td>TwelveLabs</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE, SPEECH, VIDEO</td><td>EMBEDDING</td><td>3</td></tr>
<tr><td>Pegasus v1.2</td><td><code>twelvelabs.pegasus-1-2-v1:0</code></td><td>TwelveLabs</td><td>AWS Bedrock Runtime</td><td>TEXT, VIDEO</td><td>TEXT</td><td>30</td></tr>
<tr><td>Writer Palmyra Vision 7B</td><td><code>writer.palmyra-vision-7b</code></td><td>Writer</td><td>AWS Bedrock Runtime</td><td>TEXT, IMAGE</td><td>TEXT</td><td>3</td></tr>
<tr><td>Palmyra X4</td><td><code>writer.palmyra-x4-v1:0</code></td><td>Writer</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>4</td></tr>
...
<tr><td>GLM 5</td><td><code>zai.glm-5</code></td><td>Z.AI</td><td>AWS Bedrock Runtime</td><td>TEXT</td><td>TEXT</td><td>10</td></tr>
</tbody></table>
<!-- /catalog:noscript -->
</noscript>
...
<!-- catalog:generated -->
Snapshot taken on **2026-09-08** from a stdapi.ai instance, covering 141 models across 33 AWS regions. 2 model(s) AWS no longer lists are kept, tagged `delisted`. Prices and availability move — before you commit to a number, confirm it against the [Amazon Bedrock pricing page](https://aws.amazon.com/bedrock/pricing/) and your own [`search_models`](api_search_models.md).
<!-- /catalog:generated -->
...
| --- | --- | --- | --- |
| The gateway's own [`search_models`](api_search_models.md) and [`model_pricing`](api_model_pricing.md) | — | 2026-09-08 | 141 |
| [Amazon Bedrock `ListFoundationModels`](https://docs.aws.amazon.com/bedrock/latest/APIReference/API_ListFoundationModels.html), read raw so its undocumented fields survive | — | 2026-09-08 | capabilities, APIs, media types, limits |
...
| [MTEB — Massive Text Embedding Benchmark](https://github.com/embeddings-benchmark/results) | [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/) | 2026-09-08 | 5 of 12 entries |
...
| [Amazon Bedrock model cards](https://docs.aws.amazon.com/bedrock/latest/userguide/model-cards.html) | [AWS documentation](https://aws.amazon.com/terms/) | 2026-09-08 | 113 of 126 model cards |
| [models.dev](https://models.dev/) | [MIT](https://github.com/anomalyco/models.dev/blob/dev/LICENSE) | 2026-09-08 | 66 of 125 models |
| [Open ASR Leaderboard](https://huggingface.co/spaces/hf-audio/open_asr_leaderboard) | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | 2026-09-08 | 2 of 62 entries |
