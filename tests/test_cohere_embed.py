...
class TestCohereEmbedIntegration:
    ...
    def test_several_images_embed_one_vector_each(
        ...
        The billed image count and echoed metadata are asserted too, so a
        regression under-attributing this already-paid-for call (billing one
        image where two were embedded) would be caught here as well.
